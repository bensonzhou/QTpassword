...
class Ui_passwordgenerator(object):
    def setupUi(self, passwordgenerator):
        ...
        passwordgenerator.resize(539, 431)
        icon = QtGui.QIcon()
        ...
        self.label_4 = QtWidgets.QLabel(parent=passwordgenerator)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.lineEdit_username = QtWidgets.QLineEdit(parent=passwordgenerator)
        ...
        self.horizontalLayout_5.addWidget(self.lineEdit_result)
    ...
    def retranslateUi(self, passwordgenerator):
        ...
        self.label_4.setText(_translate("passwordgenerator", "用户名："))
